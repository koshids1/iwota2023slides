...
"""
    ising2d_Dobrushin!(s, β, niters, rng)
    Update configurations of 2d Ising under Dobrushin boundary conditions
"""
function ising2d_Dobrushin!(s, β, niters, rng)
    m, n = size(s)
    min_h = -4
    max_h = 4
...
ising2d_Dobrushin!(s, β_crit, 4000, rng)
